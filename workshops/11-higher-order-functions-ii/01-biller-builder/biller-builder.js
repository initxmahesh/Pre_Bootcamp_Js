...
function billerBuilder(nameState) {
  return function func(price) {
    let correctPrice = price;
    if (nameState === "NY") {
      correctPrice = correctPrice * 1.03 * 1.04;
    } else if (nameState === "NJ") {
      correctPrice = correctPrice * 1.05 * 1.06625;
    }
    return correctPrice;
  };
}
